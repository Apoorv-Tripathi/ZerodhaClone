...
function Footer() {
    return (
        <footer className="p-3 border-top" style={{backgroundColor:"rgb(250,250,250)"}}>
            <div className="container mt-5">
                <div className="row mt-2">
                    <div className="col">
                        <img src="media/logo.svg" style={{ width: "50%" }}></img>
                        <p className="mt-4">© 2010 - 2024, Not Zerodha Broking Ltd. All rights reserved.</p>
                    </div>
                    <div className="col">
                        <p>Company</p>
                    ...
                    <div className="col">
                        ...
                        <br /><br/>
                        <a className="text-muted" style={{textDecoration:"none"}} href="">60 day challenge</a>
                        <br /><br/>
                    </div>
                </div>
                <div className="text-muted mt-5" style={{ fontSize: "16px" }}>
                    <p>
                        Zerodha Broking Ltd.: Member of NSE] & BSE E SEBI Registration no.:
                        INZ000031633 CDSL: Depository services through Zerodha Securities
                        Pvt. Ltd. E SEBI Registration no.: IN-DP-100-2015 Commodity Trading
