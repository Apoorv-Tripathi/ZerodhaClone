...
const WatchList = () => {
  ...
  const data = {
    ...
    datasets: [{
      ...
      backgroundColor: [
        ...
        "rgba(99,255,132,0.5)", "rgba(235,54,162,0.5)", "rgba(86,255,206,0.5)",
      ],
      borderColor: [
  ...
  return (
    <div className="watchlist-container">
      ...
      <ul className="list">
        {filtered.length === 0 ? (
          <li style={{ padding: "16px", color: "#aaa", fontSize: "12px", textAlign: "center" }}>
            No results for "{query}"
          </li>
        ) : (
          filtered.map((stock, index) => <WatchListItem stock={stock} key={index} />)
        )}
      </ul>
