        ...
        <div className="row align-items-center g-5">
          ...
          <div className="col-lg-7">
            <div className="row g-4">
              {[
                { img: "/media/pricingEquity.svg", price: "₹0", label: "Equity Delivery", desc: "Free for all equity delivery trades and direct mutual funds" },
                { img: "/media/intradayTrades.png", price: "₹20", label: "Intraday & F&O", desc: "Flat ₹20 or 0.03% per executed order, whichever is lower" },
              ].map(card => (
