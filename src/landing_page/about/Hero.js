        ...
        <div className='container'>
            ...
            <div className='row p-5 mt-5 border-top text-muted' style={{ lineHeight: "1.8", fontSize: "1.2rem" }}>
                <div className='col-6 p-5'>
                    ...
                    <p>
                        • Zerodha Clone – a full-fledged stock trading platform built using the MERN stack (MongoDB, Express.js, React.js, Node.js), allowing users to manage holdings, positions, and orders.<br />
                        • Postify – a Quora-style social discussion platform where users can create, edit, and view posts, built using RESTful APIs and Express.js.<br />
                        • API Wonderland – a creative platform integrating multiple public APIs to deliver random jokes, facts, and media, combining functionality with fun.<br />
                        • Simon Says Game, Spotify Homepage Clone, and more – showcasing my ability to replicate UI/UX and implement JavaScript logic with precision.
                    </p>
                </div>
                <div className='col-6 p-5'>
