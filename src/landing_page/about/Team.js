...
function Team() {
    return (
        <div className='container'>
            ...
            <div className='row' style={{ lineHeight: "1.8", fontSize: "1.3rem" }}>
                <div className='col-6 p-5 text-center text-muted' >
                    <img src='/media/ApoorvProffesionalPhoto.png' style={{ width: "80%", borderRadius: "95%", border: "2px solid black",marginTop:"50px" }}></img>
